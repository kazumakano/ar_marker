...
def detect_markers_from_img(dict_idx: int, file: str) -> None:
    ...
    util.draw_detected_markers(corners, ids, img)
...
def detect_markers_from_vid(dict_idx: int, file: str) -> None:
    pass
...
def detect_markers_on_stream(dict_idx: int, uri: str) -> None:
    ...
    while True:
        ...
        util.draw_detected_markers(*aruco.detectMarkers(img, prof_dict)[:2], img)
...
if __name__ == "__main__":
    ...
    if args.img_file is not None:
        ...
        detect_markers_from_vid(args.dict, args.vid_file)
